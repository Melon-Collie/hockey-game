...
#   - Shot     → shot power (all pools) + charge speed (how fast you load). The
#                raw-power / quick-release sniper lever.
#
...
# SHOT_CHARGE: inverted (lower = slower ramp to max power). High Shot threatens
#   at close range with a quick release.
