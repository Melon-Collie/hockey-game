...
func _draw() -> void:
	...
	# Rotate the logo to match the text orientation (the arches sit on the -X and
	# +X sides of the circle for broadcast view). The texture's native "up"
	# rotates to point in the -X direction (image left).
