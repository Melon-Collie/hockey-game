...
# not the drag direction. Set by the gamepad gatherer while RT is held — power from the
# stick magnitude, aim from its direction (bots route through is_ai_controlled() instead).
