...
func _spawn_actors_from_header(header: Dictionary) -> void:
	...
	goalie_result.bottom_goalie.set_goalie_color(_home_colors.jersey, _home_colors.helmet, _home_colors.goalie_pads, _home_colors.jersey_stripe)
	goalie_result.top_goalie.set_goalie_color(_away_colors.jersey, _away_colors.helmet, _away_colors.goalie_pads, _away_colors.jersey_stripe)
	_apply_crowd_colors()
