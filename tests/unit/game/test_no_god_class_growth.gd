...
const _SIZE_ALLOWANCE: Dictionary[String, int] = {
	...
	"res://Scripts/controllers/skater_controller.gd": 3326,
	"res://Scripts/actors/skater.gd": 2485,
	"res://Scripts/networking/network_manager.gd": 2823,
	"res://Scripts/game/tutorial_manager.gd": 2101,
	"res://Scripts/controllers/skater_skating_coordinator.gd": 1550,
...
const _API_ALLOWANCE: Dictionary[String, int] = {
	...
	"res://Scripts/networking/network_telemetry.gd": 52,
